      ...
      <div className="w-full mx-auto max-w-screen-xl px-4 py-8">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-sm text-purple-200">
              © 2023 SellAll. Todos los derechos reservados.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-4">
            <div>
              <Link
                to="/about"
                className="text-purple-100 hover:text-white hover:underline transition-colors duration-200"
              >
                Sobre Nosotros
              </Link>
            </div>
        ...
        <div className="border-t border-purple-700 mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-sm text-purple-300 mb-4 sm:mb-0">
              Hecho con ❤️ para mejorar tu experiencia de compra
            </p>
